...
o Where and what scheduling state is held?

o How to apply policy and detect and resolve conflicts?

o Ensuring synchronization of scheduled resources across distributed systems

o Establishing a scalable and resilient scheduling system. 
...
Furthermore, how to ensure the scheduling system remains operational and
can recover from failures or disruptions, providing redundancy, failover
mechanisms, and robust error handling.

o Security scheduled resources
...
More recently, the development of [draft-ietf-netmod-schedule-yang], which 
...
[draft-ietf-opsawg-ucl-acl] introduces a YANG data model for policy-based network
...
Combined, [draft-ietf-netmod-schedule-yang] and [draft-ietf-opsawg-ucl-acl] provide
...
o Resource Manager: Manages the network resources that are subject to scheduling.
o Schedule Manager: Handles creation, modification, and deletion of schedules.
o Conflict Resolver: Detects and resolves scheduling conflicts based on predefined
  policies and priorities.
o Policy Engine: Enforces scheduling policies and rules, ensuring compliance with
...
o Schedule Service Requestor API: Schedule resource creation, 
...
o Schedule Service Responder to Network API: Manages interactions with 
...
o Network Topology Information: Connection details about the physical
  and logical layout of the network, including nodes, ports/links, 
  and interconnections.
  
o Network Resource Inventory: A comprehensive list of deployed network 
  resources that are not currently in service, but may be availble if 
  enabled.  

o Current Network Utilization: Real-time data on the current usage of 
  network resources, including bandwidth consumption, CPU load,  
  memory usage, and power consumption.

o Historic Network Utilization: Past data on the current usage of 
  network resources, including bandwidth consumption, CPU load,  
  memory usage, and power consumption.
  
o Scheduled Maintenance and Planned Outages: Information on planned 
